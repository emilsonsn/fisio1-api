...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        foreach ([
            ...
            ['attachments.download', 'Baixar anexos clínicos', 'attachments'], ['users.manage', 'Gerenciar usuários e seus grupos', 'users'], ['groups.view', 'Visualizar grupos', 'groups'], ['groups.manage', 'Criar grupos e definir permissões', 'groups'], ['permissions.view', 'Visualizar catálogo de permissões', 'permissions'],
        ] as [$key, $name, $module]) {
